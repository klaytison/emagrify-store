        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/como-comprar" className="hover:text-pink-500 transition-colors">
                  Como Comprar
                </Link>
              </li>
              <li>
                <Link href="/rastreamento" className="hover:text-pink-500 transition-colors">
                  Rastrear Pedido
                </Link>
              </li>
              <li>
                <Link href="/trocas" className="hover:text-pink-500 transition-colors">
                  Trocas e Devoluções
                </Link>
              </li>
              <li>
                <Link href="/faq" className="hover:text-pink-500 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/suporte" className="hover:text-pink-500 transition-colors">
                  Central de Ajuda
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/politica-privacidade" className="hover:text-pink-500 transition-colors">
              ...
              <li>
                <Link href="/programa-pontos" className="hover:text-pink-500 transition-colors">
                  Programa de Pontos
                </Link>
              </li>
            </ul>
